...
Open a report from the [new issue](https://github.com/PathGao/kururu/issues/new/choose) page, and see [support](../SUPPORT.md) for every way to get help.
