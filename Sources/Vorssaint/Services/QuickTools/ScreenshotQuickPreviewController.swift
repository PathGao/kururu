...
final class ScreenshotQuickPreviewController {
    ...
    fileprivate static let previewSize = CGSize(width: 350, height: 210)
...
private struct ScreenshotQuickPreviewView: View {
    ...
    var body: some View {
        ...
        .padding(10)
        .frame(width: ScreenshotQuickPreviewController.previewSize.width,
               height: ScreenshotQuickPreviewController.previewSize.height)
