...
/// The one-click system actions the command bar and the radial menu run. The
/// raw value is the key of the service's in-flight guard and what a saved
/// wheel slice stores, so cases can be added but never renamed.
