...
final class DockPreviewService: ObservableObject {
    ...
    private func beginSession(_ hit: DockHit) {
        ...
        WindowPreviewProvider.shared.refreshPreviews(for: list, maxPixelSize: 420 * PreviewSizing.dockScale,
                                                     excludedAppsKey: DefaultsKey.dockPreviewExcludedApps) { [weak self] windowID, image in
...
final class DockPreviewPinnedPanel: ObservableObject, Identifiable {
    ...
    private func refreshMissingPreviews(for items: [SwitcherItem],
        ...
        previewProvider.refreshPreviews(for: items, maxPixelSize: 420 * PreviewSizing.dockScale,
                                        excludedAppsKey: DefaultsKey.dockPreviewExcludedApps) { [weak self] windowID, image in
