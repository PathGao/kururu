...
enum DockPreviewSupport {
    ...
    static var cardPadding: CGFloat { 10 * PreviewSizing.dockScale }
    static var cardTitleSpacing: CGFloat { 7 * PreviewSizing.dockScale }
    ...
    static var cardSpacing: CGFloat { 8 * PreviewSizing.dockScale }
    static var panelPadding: CGFloat { 10 * PreviewSizing.dockScale }
    ...
    static var cardThumbnailInset: CGFloat { 5 * PreviewSizing.dockScale }
    ...
    static var cardAppBadgeSize: CGFloat { 32 * PreviewSizing.dockScale }
    ...
    static var cardThumbnailWidth: CGFloat { cardThumbnailSize(scale: PreviewSizing.dockScale).width }
    static var cardThumbnailHeight: CGFloat { cardThumbnailSize(scale: PreviewSizing.dockScale).height }
    static var cardWidth: CGFloat { cardSize(scale: PreviewSizing.dockScale).width }
    static var cardHeight: CGFloat { cardSize(scale: PreviewSizing.dockScale).height }
    static var cardFallbackIconSize: CGFloat { cardFallbackIconSize(scale: PreviewSizing.dockScale) }
