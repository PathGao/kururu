...
struct RadialMenuItem: Codable, Identifiable, Equatable {
    ...
    var systemAction: QuickToggleAction? {
...
// whole menu. That is also how a kind this version dropped leaves saved
// wheels: the slice goes, the rest stays.
...
enum RadialMenuTool: String, Codable, CaseIterable, Identifiable {
    case screenshot, screenRecorder, colorPicker, screenOCR, micMute, clipboardHistory,
         scratchpad, shelf, cleaner, uninstaller, cleaningMode, keepAwake
...
extension RadialMenuSupport {
    ...
    static func claimsMouseButton(_ button: Int64, defaults: UserDefaults) -> Bool {
        guard AppFeature.radialMenu.isAvailable(in: defaults),
