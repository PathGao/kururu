    ...
    private var panelHeader: some View {
        HStack(spacing: 7) {
            ...
            if isPinned {
                ...
                .help(text.unpinPanel)
                .accessibilityLabel(text.unpinPanel)
                Button {
                    onClosePanel()
                } label: {
    ...
    private var windowNavigationButtons: some View {
        if windows.count > 1 {
            HStack(spacing: 1) {
                ...
                .accessibilityLabel(text.previousWindow)
                ...
                .accessibilityLabel(text.nextWindow)
            }
            .buttonStyle(.plain)
            .foregroundStyle(Color.secondary)
...
private struct DockPreviewCard: View {
    ...
    private var cardContextMenu: some View {
        Button {
            ...
            Label(text.openWindow, systemImage: "macwindow")
        }
        if !window.isFullscreen {
            Button {
                onToggleMinimized()
            } label: {
                Label(window.isMinimized ? text.restoreWindow : text.minimizeWindow,
        ...
        Button {
            ...
            Label(isPanelPinned ? text.unpinPanel : text.pinPanel,
    ...
    private var minimizeButton: some View {
        ...
        .help(window.isMinimized ? text.restoreWindow : text.minimizeWindow)
        .accessibilityLabel(window.isMinimized ? text.restoreWindow : text.minimizeWindow)
    }
}
