...
struct UtilitiesSection: View {
    ...
    private func itemView(_ item: UtilityPanelItem, editing: Bool) -> some View {
        ...
        case .clipboard:
            UtilityActionButton(title: AppFeature.clipboardHistory.name(l10n.s, language: l10n.language),
        ...
        case .cleaner:
            UtilityActionButton(title: AppFeature.cleaner.name(l10n.s, language: l10n.language),
        ...
        case .cleanURL:
            UtilityActionButton(title: AppFeature.urlCleaner.name(l10n.s, language: l10n.language),
        ...
        case .cleaning:
            UtilityActionButton(title: AppFeature.cleaningMode.name(l10n.s, language: l10n.language),
        ...
        case .screenOCR:
            UtilityActionButton(title: AppFeature.screenOCR.name(l10n.s, language: l10n.language),
                                caption: ocrCaption,
        ...
        case .screenshot:
            UtilityActionButton(title: AppFeature.screenshot.name(l10n.s, language: l10n.language),
        ...
        case .colorPicker:
            UtilityActionButton(title: AppFeature.colorPicker.name(l10n.s, language: l10n.language),
        ...
        case .scratchpad:
            UtilityActionButton(title: AppFeature.scratchpad.name(l10n.s, language: l10n.language),
    ...
    private var screenRecorderTitle: String {
        ...
        return recorder.isRecording ? strings.stopButton : AppFeature.screenRecorder.name(l10n.s, language: l10n.language)
    }
...
struct QuickControlsSection: View {
    ...
    private var dockPreviewCaption: String {
        let text = FeatureStrings.dockPreview(l10n.language)
    ...
    private func itemView(_ item: ControlPanelItem, editing: Bool) -> some View {
        switch item {
        case .mouseScroll:
            PanelToggleRow(title: AppFeature.scrollInverter.name(l10n.s, language: l10n.language),
        ...
        case .focusFollowsMouse:
            PanelToggleRow(title: AppFeature.focusFollowsMouse.name(l10n.s, language: l10n.language),
        ...
        case .switcher:
            VStack(alignment: .leading, spacing: 5) {
                PanelToggleRow(title: AppFeature.switcher.name(l10n.s, language: l10n.language),
        ...
        case .keyDebounce:
            VStack(alignment: .leading, spacing: 5) {
                PanelToggleRow(title: AppFeature.keyboardDebounce.name(l10n.s, language: l10n.language),
        ...
        case .cutPaste:
            PanelToggleRow(title: AppFeature.finderCutPaste.name(l10n.s, language: l10n.language),
        ...
        case .autoQuit:
            PanelToggleRow(title: AppFeature.autoQuit.name(l10n.s, language: l10n.language),
        ...
        case .shelf:
            PanelToggleRow(title: AppFeature.shelf.name(l10n.s, language: l10n.language),
        ...
        case .windowMaximize:
            PanelToggleRow(title: AppFeature.windowMaximizer.name(l10n.s, language: l10n.language),
        ...
        case .dockPreview:
            PanelToggleRow(title: AppFeature.dockPreview.name(l10n.s, language: l10n.language),
        ...
        case .dockClick:
            let dockClickText = FeatureStrings.dockClick(l10n.language)
            PanelToggleRow(title: dockClickText.minimize,
                           caption: caption(dockClickText.minimizeCaption, needsAccessibility: dockClickEnabled),
        ...
        case .dockClickHide:
            let dockClickText = FeatureStrings.dockClick(l10n.language)
            PanelToggleRow(title: dockClickText.hide,
                           caption: caption(dockClickText.hideCaption, needsAccessibility: dockClickHideEnabled),
        ...
        case .dockClickCycle:
            let dockClickText = FeatureStrings.dockClick(l10n.language)
            PanelToggleRow(title: dockClickText.cycleWindows,
                           caption: caption(dockClickText.cycleWindowsCaption, needsAccessibility: dockClickCycleEnabled),
                           systemImage: "dock.rectangle",
        ...
        case .textSnippets:
            ...
            PanelToggleRow(title: AppFeature.textSnippets.name(l10n.s, language: l10n.language),
                           ...
                           accessoryAction: {
                               SettingsRouter.shared.page = .keyboard
                               appDelegate()?.openSettingsWindow()
                           })
        ...
        case .radialMenu:
            ...
            PanelToggleRow(title: AppFeature.radialMenu.name(l10n.s, language: l10n.language),
        ...
        case .mouseButtonShortcuts:
            ...
            PanelToggleRow(title: AppFeature.mouseButtonShortcuts.name(l10n.s, language: l10n.language),
        ...
        case .superKey:
            ...
            PanelToggleRow(title: AppFeature.superKey.name(l10n.s, language: l10n.language),
        ...
        case .mouseAcceleration:
            PanelToggleRow(title: AppFeature.mouseAcceleration.name(l10n.s, language: l10n.language),
        ...
        case .mouseClickDebounce:
            ...
            PanelToggleRow(title: AppFeature.mouseClickDebounce.name(l10n.s, language: l10n.language),
...
// Internal (not private): every action row in the panel is built from this
// one component, so they all look and behave the same.
...
/// Shared switch row used by the Quick controls section.
...
struct KeepAwakeCard: View {
    ...
    var body: some View {
        ...
        PanelSection(.keepAwake, title: AppFeature.keepAwake.name(l10n.s, language: l10n.language), collapsible: collapsible) {
            VStack(alignment: .leading, spacing: 10) {
                HStack {
                    statusLine
                    Spacer()
