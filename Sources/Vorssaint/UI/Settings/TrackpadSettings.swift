...
struct TrackpadSettings: View {
    ...
    private var needsTrackpadInput: Bool { middleClickWanted || !activeRadialTapFingers.isEmpty }
    private var needsThreeFingerInput: Bool { middleClickWanted || activeRadialTapFingers.contains(3) }
