...
struct RadialMenuView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(AppFeature.radialMenu.name(l10n.s, language: l10n.language))
    }
...
extension RadialMenuItem {
    func displayName(_ text: RadialMenuFeatureStrings,
        ...
        case .tool:
            ...
            return tool.feature.name(L10n.shared.s, language: L10n.shared.language)
        case .systemAction:
            return systemAction?.title ?? text.kindSystemAction
        case .media:
            switch mediaKey {
