...
struct PortManagerFeatureStrings {
    var title: String = "Port Manager"
    var filter: String = "Filter by port, process, or PID"
    var openFormat: String = "%d open"
    var empty: String = "No listening ports found"
    var emptyHint: String = "Try refreshing or changing your search."
    var listeningCaption: String = "Your listening ports"
    var kill: String = "Kill"
    var forceKill: String = "Force Kill"
    var loadFailed: String = "Could not read listening ports. Try refreshing."
    var refresh: String = "Refresh"
    var terminateFormat: String = "Terminate %@?"
    var terminateMessageFormat: String = "This closes port %d by terminating PID %d."
    var hubDescription: String = "View active listening ports and, with Kill Process installed, terminate the processes using them"
}
