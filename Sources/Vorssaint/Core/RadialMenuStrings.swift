...
struct RadialMenuFeatureStrings {
    ...
    var kindTool: String = "\(AppInfo.name) tool"
    ...
    var buttonTestSeen: String = "\(AppInfo.name) sees this button"
    var buttonTestOther: String = "That was a different button"
    var buttonTestBlind: String = "\(AppInfo.name) cannot watch the mouse right now"
...
extension RadialMenuFeatureStrings {
    ...
    static let ptBR = RadialMenuFeatureStrings(
        ...
        kindTool: "Ferramenta do \(AppInfo.name)",
        kindSystemAction: "Atalhos rápidos",
        ...
        buttonTestSeen: "O \(AppInfo.name) enxerga esse botão",
        buttonTestOther: "Esse foi outro botão",
        buttonTestBlind: "O \(AppInfo.name) não consegue observar o mouse agora",
    ...
    static let tr = RadialMenuFeatureStrings(
        ...
        kindTool: "\(AppInfo.name) aracı",
        kindSystemAction: "Hızlı geçişler",
        ...
        buttonTestSeen: "\(AppInfo.name) bu düğmeyi görüyor",
        buttonTestOther: "Bu başka bir düğmeydi",
        buttonTestBlind: "\(AppInfo.name) şu anda fareyi izleyemiyor",
    ...
    static let ru = RadialMenuFeatureStrings(
        ...
        kindTool: "Инструмент \(AppInfo.name)",
        kindSystemAction: "Быстрые переключатели",
        ...
        buttonTestSeen: "\(AppInfo.name) видит эту кнопку",
        buttonTestOther: "Это была другая кнопка",
        buttonTestBlind: "\(AppInfo.name) сейчас не может следить за мышью",
    ...
    static let es = RadialMenuFeatureStrings(
        ...
        kindTool: "Herramienta de \(AppInfo.name)",
        kindSystemAction: "Ajustes rápidos",
        ...
        buttonTestSeen: "\(AppInfo.name) ve este botón",
        buttonTestOther: "Ese fue otro botón",
        buttonTestBlind: "\(AppInfo.name) no puede observar el ratón ahora",
    ...
    static let de = RadialMenuFeatureStrings(
        ...
        kindTool: "\(AppInfo.name)-Werkzeug",
        kindSystemAction: "Schnellschalter",
        ...
        buttonTestSeen: "\(AppInfo.name) sieht diese Taste",
        buttonTestOther: "Das war eine andere Taste",
        buttonTestBlind: "\(AppInfo.name) kann die Maus gerade nicht beobachten",
    ...
    static let fr = RadialMenuFeatureStrings(
        ...
        kindTool: "Outil \(AppInfo.name)",
        kindSystemAction: "Boutons rapides",
        ...
        buttonTestSeen: "\(AppInfo.name) voit ce bouton",
        buttonTestOther: "C’était un autre bouton",
        buttonTestBlind: "\(AppInfo.name) ne peut pas observer la souris pour le moment",
    ...
    static let it = RadialMenuFeatureStrings(
        ...
        kindTool: "Strumento \(AppInfo.name)",
        kindSystemAction: "Interruttori rapidi",
        ...
        buttonTestSeen: "\(AppInfo.name) vede questo pulsante",
        buttonTestOther: "Quello era un altro pulsante",
        buttonTestBlind: "\(AppInfo.name) non riesce a osservare il mouse in questo momento",
    ...
    static let ja = RadialMenuFeatureStrings(
        ...
        kindTool: "\(AppInfo.name)のツール",
        kindSystemAction: "クイック切り替え",
        ...
        buttonTestSeen: "\(AppInfo.name) はこのボタンを認識しています",
        buttonTestOther: "いまのは別のボタンです",
        buttonTestBlind: "\(AppInfo.name) はいまマウスを見られません",
    ...
    static let ko = RadialMenuFeatureStrings(
        ...
        kindTool: "\(AppInfo.name) 도구",
        kindSystemAction: "빠른 전환",
        kindMedia: "미디어 제어",
        kindSubmenu: "하위 메뉴",
        chooseButton: "선택…",
        ...
        buttonTestSeen: "\(AppInfo.name)가 이 버튼을 인식합니다",
        buttonTestOther: "방금 것은 다른 버튼입니다",
        buttonTestBlind: "지금은 \(AppInfo.name)가 마우스를 살펴볼 수 없습니다",
    ...
    static let zhHans = RadialMenuFeatureStrings(
        ...
        kindURL: "打开链接",
        kindShortcut: "按下快捷键",
        kindTool: "\(AppInfo.name) 工具",
        kindSystemAction: "快捷开关",
        kindMedia: "媒体控制",
        kindSubmenu: "子菜单",
        chooseButton: "选择…",
        urlPlaceholder: "example.com",
        ...
        buttonTestSeen: "\(AppInfo.name) 能看到这个按键",
        buttonTestOther: "刚才是另一个按键",
        buttonTestBlind: "\(AppInfo.name) 现在无法观察鼠标",
    ...
    static let zhTW = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "\(AppInfo.name) 看得到這個按鍵",
        buttonTestOther: "剛才是另一個按鍵",
        buttonTestBlind: "\(AppInfo.name) 目前無法觀察滑鼠",
