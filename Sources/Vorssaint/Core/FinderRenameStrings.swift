...
struct FinderRenameFeatureStrings {
    var pageTitle: String = "Finder shortcuts"
    var hubTitle: String = "Rename shortcut"
    var hubDescription: String = "Rename the selected file or folder with a shortcut you choose."
    var enableLabel: String = "Use a shortcut to rename"
    var caption: String = "The shortcut only acts in Finder and leaves text fields alone. F2 works as a regular key; on keyboards where it controls brightness, use Fn-F2 or choose another shortcut."
    var shortcutLabel: String = "Rename"
}
