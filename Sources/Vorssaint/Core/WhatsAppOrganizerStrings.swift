...
struct WhatsAppOrganizerStrings {
    ...
    var enabled: String = "Automatically organize downloaded files"
    var automaticOff: String = "Automatic organization is off"
    var enabledCaption: String = "WhatsApp may download a moved file again. \(AppInfo.name) cannot prevent the network download, but it can detect and discard an identical extra copy."
...
extension WhatsAppOrganizerStrings {
    ...
    static let es = WhatsAppOrganizerStrings(
        ...
        enabled: "Organizar automáticamente los archivos descargados",
        automaticOff: "La organización automática está desactivada",
        enabledCaption: "WhatsApp puede volver a descargar un archivo movido. \(AppInfo.name) no puede impedir esa descarga, pero sí detectar y descartar una nueva copia idéntica.",
    ...
    static let ptBR = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "O WhatsApp pode baixar novamente um arquivo movido. O \(AppInfo.name) não impede o download, mas detecta e descarta uma nova cópia idêntica.",
    ...
    static let de = WhatsAppOrganizerStrings(
        ...
        enabled: "Heruntergeladene Dateien automatisch organisieren",
        automaticOff: "Automatische Organisation ist ausgeschaltet",
        enabledCaption: "WhatsApp kann eine verschobene Datei erneut herunterladen. \(AppInfo.name) kann den Netzwerk-Download nicht verhindern, aber eine identische zusätzliche Kopie erkennen und aussortieren.",
    ...
    static let fr = WhatsAppOrganizerStrings(
        ...
        enabled: "Organiser automatiquement les fichiers téléchargés",
        automaticOff: "L’organisation automatique est désactivée",
        enabledCaption: "WhatsApp peut retélécharger un fichier déplacé. \(AppInfo.name) ne peut pas empêcher le téléchargement réseau, mais peut détecter et écarter une copie supplémentaire identique.",
    ...
    static let it = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp può scaricare di nuovo un file spostato. \(AppInfo.name) non può impedire il download di rete, ma può rilevare e scartare una copia aggiuntiva identica.",
    ...
    static let tr = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp taşınan bir dosyayı yeniden indirebilir. \(AppInfo.name) ağ indirmesini engelleyemez, ancak birebir aynı fazladan kopyayı saptayıp ayıklayabilir.",
    ...
    static let ru = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp может снова загрузить перемещённый файл. \(AppInfo.name) не может помешать сетевой загрузке, но распознаёт идентичную лишнюю копию и отсеивает её.",
    ...
    static let ja = WhatsAppOrganizerStrings(
        ...
        enabled: "ダウンロードしたファイルを自動で整理",
        automaticOff: "自動整理はオフです",
    ...
    static let zhHans = WhatsAppOrganizerStrings(
        ...
        enabled: "自动整理下载文件",
        automaticOff: "自动整理已关闭",
        enabledCaption: "WhatsApp 可能会再次下载已移动的文件。\(AppInfo.name) 无法阻止网络下载，但能识别并剔除完全相同的多余副本。",
        destination: "目标文件夹",
        chooseFolder: "选择…",
    ...
    static let zhTW = WhatsAppOrganizerStrings(
        ...
        enabled: "自動整理下載檔案",
        automaticOff: "自動整理已關閉",
        enabledCaption: "WhatsApp 可能會再次下載已移動的檔案。\(AppInfo.name) 無法阻止網路下載，但能辨識並剔除完全相同的多餘副本。",
        destination: "目標資料夾",
        chooseFolder: "選擇…",
