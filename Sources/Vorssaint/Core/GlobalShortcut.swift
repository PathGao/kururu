...
enum GlobalShortcutRole: CaseIterable, Identifiable {
    ...
    func title(_ strings: Strings) -> String {
        ...
        case .soundOutputSwitcher: return FeatureStrings.soundOutputSwitcher(L10n.shared.language).pageTitle
        ...
        case .micMute: return FeatureStrings.micMute(L10n.shared.language).pageTitle
        case .screenshot:
