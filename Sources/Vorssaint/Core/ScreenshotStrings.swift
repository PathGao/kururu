...
struct ScreenshotFeatureStrings {
    ...
    var previewFocusCaption: String = "Shortcuts work the moment the preview appears, but the keyboard leaves the app you were using until it closes."
...
extension ScreenshotFeatureStrings {
    ...
    static let ptBR = ScreenshotFeatureStrings(
        ...
        hideVorssaintWindowsToggle: "Ocultar janelas do \(AppInfo.name)",
    ...
    static let tr = ScreenshotFeatureStrings(
        ...
        hideVorssaintWindowsToggle: "\(AppInfo.name) pencerelerini gizle",
    ...
    static let ru = ScreenshotFeatureStrings(
        ...
        hideVorssaintWindowsToggle: "Скрывать окна \(AppInfo.name)",
    ...
    static let es = ScreenshotFeatureStrings(
        ...
        hideVorssaintWindowsToggle: "Ocultar ventanas de \(AppInfo.name)",
    ...
    static let de = ScreenshotFeatureStrings(
        ...
        hideVorssaintWindowsToggle: "\(AppInfo.name)-Fenster ausblenden",
    ...
    static let fr = ScreenshotFeatureStrings(
        ...
        hideVorssaintWindowsToggle: "Masquer les fenêtres \(AppInfo.name)",
    ...
    static let it = ScreenshotFeatureStrings(
        ...
        hideVorssaintWindowsToggle: "Nascondi le finestre di \(AppInfo.name)",
    ...
    static let ja = ScreenshotFeatureStrings(
        ...
        hideVorssaintWindowsToggle: "\(AppInfo.name)のウインドウを隠す",
    ...
    static let ko = ScreenshotFeatureStrings(
        ...
        hideVorssaintWindowsToggle: "\(AppInfo.name) 윈도우 가리기",
    ...
    static let zhTW = ScreenshotFeatureStrings(
        ...
        previewPositionBottomLeft: "左下角",
        previewPositionBottomRight: "右下角",
        hideVorssaintWindowsToggle: "隱藏 \(AppInfo.name) 視窗",
