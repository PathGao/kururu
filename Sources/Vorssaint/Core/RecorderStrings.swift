...
struct RecorderFeatureStrings {
    var pageTitle: String = "Screen recording"
    var hubDescription: String = "Records an area, window or screen and edits it afterwards"
    var panelCaption: String = "Record an area, window or the whole screen"
    var startButton: String = "Record now"
    var stopButton: String = "Stop recording"
    var fileNamePrefix: String = "Recording"
    var selectionPurpose: String = "Choose what to record"
    var indicatorTooltip: String = "Recording controls"
    var countdownLabel: String = "Countdown"
    var countdownOff: String = "Off"
    var countdownSecondsFormat: String = "%d s"
    var qualityLabel: String = "Quality"
    var qualitySmall: String = "Small file"
    var qualityBalanced: String = "Balanced"
    var qualityHigh: String = "High"
    var qualityCaption: String = "Balanced fits most uses. High keeps every detail and makes bigger files."
    var frameRateLabel: String = "Frames per second"
    var frameRateFormat: String = "%d fps"
    var systemAudioToggle: String = "Record the sound of the Mac"
    var systemAudioCaption: String = "Everything you hear goes into the recording, on its own track, so you can silence it later."
    ...
    var discardButton: String = "Delete"
    var copiedHUD: String = "Recording copied"
    var savedHUDFormat: String = "Saved to %@"
    var recordFailed: String = "The screen could not be recorded"
    var noSpaceTitle: String = "Not enough space to record"
    var noSpaceMessage: String = "Free up some space on the disk and try again."
    var stoppedNoSpaceHUD: String = "Recording stopped, the disk is almost full"
    var shortcutLabel: String = "Shortcut"
    var editorTitle: String = "Recording"
    var saveVideoButton: String = "Save"
    var saveGIFButton: String = "Save as GIF"
    var exportingLabel: String = "Saving…"
    var cancelButton: String = "Cancel"
    var exportFailed: String = "The recording could not be saved"
    var gifTooLongFormat: String = "A GIF can be up to %d seconds long"
    var gifSizeLabel: String = "GIF size"
    var gifSizeSmall: String = "Small"
    var gifSizeMedium: String = "Medium"
    var gifSizeLarge: String = "Large"
    var gifFrameRateLabel: String = "GIF smoothness"
    var discardTitle: String = "Delete this recording?"
    var discardMessage: String = "It has not been saved anywhere yet."
    var openEditorToggle: String = "Open the editor after recording"
    var openEditorCaption: String = "The recording opens ready to trim, mute and save. Turn this off to get the file straight away."
    var lookLabel: String = "Look"
    var lookRaw: String = "Original"
    var lookClean: String = "Smooth"
    var lookStudio: String = "Studio"
    var lookCaption: String = "A starting point. Change anything below and it stays changed."
    var pointerSectionLabel: String = "Pointer"
    var pointerShowToggle: String = "Draw the pointer"
    var pointerSmoothingLabel: String = "Smoothing"
    var pointerSmoothingOff: String = "None"
    var pointerSmoothingLight: String = "Light"
    var pointerSmoothingSmooth: String = "Smooth"
    var pointerSmoothingCinematic: String = "Cinematic"
    var pointerSizeLabel: String = "Size"
    var clickRingToggle: String = "Mark where you click"
    var zoomSectionLabel: String = "Zoom"
    var zoomToggle: String = "Zoom in on every click"
    var zoomAmountLabel: String = "How close"
    var backgroundSectionLabel: String = "Background"
    var shapeLabel: String = "Shape"
    var shapeOriginal: String = "Original"
    var shapeWide: String = "Wide"
    var shapeSquare: String = "Square"
    var shapeVertical: String = "Tall"
    var noPointerNote: String = "This recording has no pointer track, so there is nothing to smooth. Zooms placed by hand still work."
    var zoomLaneEmptyHint: String = "Click here to add a zoom"
    var addZoomButton: String = "Add a zoom"
    var removeZoom: String = "Remove"
    var thisZoomLabel: String = "This zoom"
    var zoomWhereLabel: String = "Where it looks"
    var zoomFollowsPointer: String = "Follows the pointer"
    var zoomPickSpot: String = "Pick a spot"
    var zoomPickSpotHint: String = "Click the picture to aim it"
    var regenerateZooms: String = "Back to one per click"
    var backToOptions: String = "All options"
    var cutOutButton: String = "Cut out"
    var cutHint: String = "Drag across the film to pick a part to remove"
    var addTextButton: String = "Add text"
    var textLaneEmptyHint: String = "Click here to add text"
    var thisTextLabel: String = "This text"
    var textPlaceholder: String = "Your text here"
    var textContentLabel: String = "Text"
    var textSizeLabel: String = "Size"
    var textPositionLabel: String = "Position"
    var textColorLabel: String = "Colour"
    var removeText: String = "Remove"
    var copyAndDeleteButton: String = "Copy and delete"
    var saveAsButton: String = "Save as…"
    var discardSavedMessage: String = "Saved and copied files will stay where they are."
    var presetsButton: String = "Presets"
    var savePreset: String = "Save current preset…"
    var presetNamePlaceholder: String = "Preset name"
    var removePreset: String = "Remove preset"
    var zoomEmptyTitle: String = "No zooms yet"
    var zoomEmptyCaption: String = "Create them from your clicks or add one on the timeline."
    var createAutomaticZooms: String = "Create automatic zooms"
    var typingZoomToggle: String = "Keep zoomed in while typing"
    var typingZoomCaption: String = "After a click, typing keeps the automatic zoom on that spot."
    var microphoneToggle: String = "Record the microphone"
    var microphoneCaption: String = "Your voice goes into its own track and stays adjustable in the editor."
    var systemAudioTrackLabel: String = "Mac sound"
    var microphoneTrackLabel: String = "Microphone"
    var audioVolumeLabel: String = "Volume"
    var removeAudio: String = "Remove"
    var restoreAudio: String = "Restore"
    var microphoneUnavailableHUD: String = "Microphone unavailable"
    var microphonePermissionName: String = "Microphone"
    var microphonePermissionExplain: String = "Lets screen recordings include your voice when you turn it on."
    var automaticZoomToggle: String = "Add zooms automatically"
    var automaticZoomCaption: String = "Turn this off to start new recordings without zooms. You can still add them in the editor."
    var pauseButton: String = "Pause recording"
    var resumeButton: String = "Resume recording"
    var blurLaneLabel: String = "Blur"
    var addBlurButton: String = "Blur an area"
    var blurLaneEmptyHint: String = "Click here to add a blur"
    var thisBlurLabel: String = "This blur"
    var blurPickArea: String = "Choose the area"
    var blurPickAreaHint: String = "Drag over what should stay hidden"
    var blurCaption: String = "Hidden for as long as its block lasts on the timeline."
    var addImageButton: String = "Add image"
    var imageLaneLabel: String = "Image"
    var imageLaneEmptyHint: String = "Click here to add an image"
    var thisImageLabel: String = "This image"
    var imageSizeLabel: String = "Size"
    var imageOpacityLabel: String = "Opacity"
    var imagePositionLabel: String = "Position"
    var imageImportFailed: String = "Couldn’t add this image."
}
