...
- Independent release and development identities, an octopus icon shared with the interface, and project links to PathGao/kururu. Numbered releases below record upstream history; their feature descriptions do not define the current fork's scope.
