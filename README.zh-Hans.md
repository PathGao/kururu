...
需要搭载 **Apple Silicon 芯片的 Mac**，运行 **macOS 14 或更新版本**。当前发布版本为 [0.1.5](https://github.com/PathGao/kururu/releases/tag/v0.1.5)。
...
查看 CPU、GPU、内存、网络、磁盘和电源指标，通过历史曲线了解变化。检查电池健康与活动情况。端口管理器列出进程监听的 TCP 端口，安装“结束进程”后还可以结束这些进程。
