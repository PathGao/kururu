...
enum ScrollHorizontalModifierTests {
    static func run(_ suite: TestSuite) {
        ...
        suite.expect(AppFeature.scrollHorizontal.unit == .mouse
            && AppFeature.scrollHorizontal.pageSwitchKey == DefaultsKey.scrollHorizontalEnabled,
            "the feature installs with the mouse unit and keeps its own switch off")
