...
enum ProductSettingsTests {
    static func run(_ expect: (Bool, String) -> Void) {
        ...
        expect(current.version == "0.1.1", "current kururu build selects the new release")
        ...
        expect(ReleaseNotes.allVersions(changelog: changelog) == ["0.1.1", "0.1.0", "3.3.5"], "product release precedes upstream history; unreleased is omitted")
        ...
        expect(labels.allSatisfy { $0 == "v0.1.1 · 2026-09-15" }, "all locales show the product release version and date")
