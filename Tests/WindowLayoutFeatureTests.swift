...
enum WindowLayoutFeatureTests {
    ...
    /// Ported from upstream's pointer-input suite, which this fork does not
    /// carry: the drag, resize and directional-ring rules of window layout.
    static func gestures(_ suite: TestSuite) {
