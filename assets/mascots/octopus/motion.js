...
const svgMarkup=`<svg viewBox="-145 -125 290 270" role="img" aria-label="具有圆润头部和渐细腕足的章鱼"><defs><linearGradient id="skin" gradientUnits="userSpaceOnUse" x1="-60" y1="-90" x2="85" y2="120"><stop stop-color="#555861"/><stop offset=".5" stop-color="#303239"/><stop offset="1" stop-color="#191b20"/></linearGradient><clipPath id="faceClip"><path class="faceClipPath"/></clipPath></defs><ellipse class="shadow" cy="122" rx="64" ry="5"/><g class="head"><g class="rear">${[0,1,2,3].map(armMarkup).join('')}</g><path class="web" fill="url(#skin)"/><path class="body"/><g class="face" clip-path="url(#faceClip)"><path class="eye left"/><path class="eye right"/></g><g class="front">${[4,5,6,7].map(armMarkup).join('')}</g></g></svg>`;
